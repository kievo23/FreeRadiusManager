...
/**
 * SuspenseSearch represents the model behind the search form about `app\models\Suspense`.
 */
class SuspenseSearch extends Suspense
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['mpesa_id', 'original', 'destination', 'test', 'mpesa_code', 'mpesa_acc', 'mpesa_msidn', 'mpesa_amount', 'mpesa_sender', 'actual_uri', 'timestamp'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'mpesa_id', $this->mpesa_id])
            ...
            ->andFilterWhere(['like', 'actual_uri', $this->actual_uri]);
